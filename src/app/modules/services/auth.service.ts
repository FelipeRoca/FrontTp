...
export class AuthService {
  ...
  private _currentUser = signal<User | null>(null); // Usuario actual
  private _authStatus = signal<AuthStatus>(AuthStatus.checking); // Estado de autenticación

  public currentUser = computed(() => this._currentUser()); // Computed para usuario
  public authStatus = computed(() => this._authStatus()); // Computed para estado de autenticación
